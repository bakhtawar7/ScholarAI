...
async function main() {
  ...
  const scholarshipsData = [
    {
      ...
      accommodationDetails:
        'University housing placement assistance and subsidized international student residence guarantee.',
      minGpa: 3.2,
      maxGpaScale: 4.0,
      gpaRequirements:
        'Minimum cumulative GPA of 3.2/4.0 (or equivalent First Class / Upper Second Class honours) in Computer Science or related STEM field.',
      ...
      eligibilityDescription:
        'Applicants must hold an accredited Bachelor degree (180 ECTS min) in Computer Science, Mathematics, or Software Engineering with strong foundations in linear algebra, algorithms, and probability.',
      ...
      applicationProcess:
        '1. Register on the EMJMD consortium application portal. 2. Select AI track mobility path. 3. Upload all notarized academic credentials and SOP. 4. Submit before the December consortium scholarship deadline.',
    ...
    },
    {
      ...
      accommodationCoverage: true,
      accommodationDetails:
        'Monthly rent subsidy allowance plus comprehensive health, accident, and personal liability insurance covered.',
      minGpa: 3.0,
      maxGpaScale: 4.0,
      gpaRequirements:
        'Minimum GPA of 3.0/4.0 in completed undergraduate study with above-average performance ratings.',
      eligibleNationalities: JSON.stringify([]),
      nationalityRequirements:
        'Targeted for international graduates from developing and emerging countries (DAC List of ODA Recipients).',
      languageRequirements: JSON.stringify({ IELTS: 6.5, TOEFL: 80 }),
      eligibilityDescription:
        'Candidates must possess at least 2 years of professional work experience following completion of their bachelor degree, and demonstrate direct relevance to sustainable socioeconomic development.',
      requiredDocuments: JSON.stringify([
      ...
      applicationProcess:
        'Apply directly to the designated EPOS Master/PhD program coordinator at the chosen German university, specifying scholarship consideration.',
    ...
    },
    {
      ...
      eligibleNationalities: JSON.stringify([]),
      nationalityRequirements:
        'Citizens of participating Fulbright partner nations globally (must reside in home country at time of application).',
      languageRequirements: JSON.stringify({ TOEFL: 100, GRE: 310, IELTS: 7.5 }),
      eligibilityDescription:
        'Designed for young professionals and recent graduates demonstrating high academic merit, leadership potential, and commitment to cross-cultural exchange and home-country development.',
      requiredDocuments: JSON.stringify([
      ...
      applicationProcess:
        'Submit your complete dossier through the official US Embassy / Binational Fulbright Commission online portal in your home country.',
    ...
    },
    {
      ...
      eligibilityDescription:
        'Requires at least 2,800 hours (approx. 2 years) of verifiable work experience, proven leadership skills, and clear strategy for creating positive change in home country upon return.',
      requiredDocuments: JSON.stringify([
      ...
      applicationProcess:
        'Submit your online application through Chevening portal including 4 mandatory essays; short-listed candidates undergo panel interview at British Embassy.',
    ...
    },
    {
      ...
      accommodationCoverage: true,
      accommodationDetails:
        'Single economy airfare at start and end of course, inbound visa costs, NHS immigration healthcare surcharge.',
      minGpa: 3.8,
      maxGpaScale: 4.0,
      ...
      eligibilityDescription:
        'Candidates must demonstrate outstanding intellectual ability, reasons for choice of course, commitment to improving the lives of others, and leadership capacity.',
      requiredDocuments: JSON.stringify([
      ...
      applicationProcess:
        'Apply for admission to a postgraduate degree and Gates Cambridge Scholarship simultaneously via the University of Cambridge Graduate Applicant Portal.',
    ...
    },
    {
      ...
      eligibilityDescription:
        'Applicants must be under 35 years of age and willing to study Japanese language during the preparatory 6-month period.',
      requiredDocuments: JSON.stringify([
      ...
      applicationProcess:
        'Apply either through the Embassy Recommendation track (via Japanese Embassy in your country) or University Recommendation track.',
    ...
    },
    {
      ...
      eligibleNationalities: JSON.stringify([]),
      nationalityRequirements:
        'Open to all international graduates with passion for biomedical, physical sciences, and engineering research.',
      languageRequirements: JSON.stringify({ IELTS: 6.5, TOEFL: 90 }),
      eligibilityDescription:
        'Candidates must possess excellent academic records, strong interest in advanced research, and exceptional English communication skills.',
      requiredDocuments: JSON.stringify([
      ...
      applicationProcess:
        'Apply online through the A*STAR SINGA portal. Select supervisor and research project from NTU, NUS, or SUTD rosters.',
    ...
    },
    {
      ...
      eligibleNationalities: JSON.stringify([]),
      nationalityRequirements:
        'Applicants must hold foreign citizenship (neither applicant nor parents can be Korean citizens).',
      languageRequirements: JSON.stringify({ IELTS: 6.5, TOEFL: 83 }),
      eligibilityDescription:
        'High academic distinction in mathematical and technical domains; strong coding skills in C/C++/Python for computing tracks.',
      requiredDocuments: JSON.stringify([
      ...
      applicationProcess:
        'Check "KAIST Scholarship" checkbox during standard online application submission on the KAIST admissions portal.',
    ...
    },
    {
      ...
      accommodationCoverage: true,
      accommodationDetails:
        'Mandatory Swiss health insurance coverage paid directly by FCS, plus CHF 300 one-time housing allowance.',
      minGpa: 3.6,
      maxGpaScale: 4.0,
      ...
      eligibilityDescription:
        'Requires a prior written confirmation letter from an accredited Swiss university professor agreeing to supervise your PhD or research fellowship.',
      requiredDocuments: JSON.stringify([
      ...
      applicationProcess:
        'Obtain written commitment from an ETH/EPFL/Swiss host professor, then submit dossier to Swiss Embassy in your home country.',
    ...
    },
    {
      ...
      languageRequirements: JSON.stringify({ IELTS: 6.5, TOEFL: 90 }),
      eligibilityDescription:
        'Must possess at least 3,000 hours of documented work experience and demonstrated leadership experience in community/workplace.',
      requiredDocuments: JSON.stringify([
      ...
      applicationProcess:
        '1. Apply for eligible master programs via universityadmissions.se. 2. Submit SI scholarship application on SI portal during February call.',
    ...
    },
    {
      ...
      accommodationCoverage: true,
      accommodationDetails:
        'Relocation allowance up to AUD $2,000 and Overseas Student Health Cover (OSHC) single policy.',
      minGpa: 3.5,
      maxGpaScale: 4.0,
      ...
      eligibilityDescription:
        'Applicants must show strong research publication capacity or exceptional undergraduate research honours thesis.',
      requiredDocuments: JSON.stringify([
      ...
      applicationProcess:
        'Apply directly through the target Australian university graduate research school portal, ticking RTP scholarship consideration.',
    ...
    },
    {
      ...
      accommodationCoverage: true,
      accommodationDetails:
        'Direct housing assistance, international return airfare, cultural activities, and Campus France health coverage.',
      minGpa: 3.4,
      maxGpaScale: 4.0,
      gpaRequirements: 'Minimum GPA of 3.4/4.0 (Top 10% class rank).',
      eligibleNationalities: JSON.stringify([]),
      nationalityRequirements:
        'Open to foreign candidates (French dual nationals ineligible). Age limit: 25 for Master, 30 for PhD.',
      languageRequirements: JSON.stringify({ IELTS: 6.5, TOEFL: 88 }),
      eligibilityDescription:
        'Designed for elite international students nominated directly by French universities to study high-priority engineering and science courses.',
      requiredDocuments: JSON.stringify([
      ...
      applicationProcess:
        'Contact the international admissions office of your target French university; the French institution evaluates and nominates you directly to Campus France.',
  ...
  for (const s of scholarshipsData) {
    ...
    const isMatched =
      s.fieldsOfStudy.includes('Computer Science') || s.fieldsOfStudy.includes('Artificial Intelligence');
    const reasons = [
    ...
    await prisma.scholarshipMatch.create({
      data: {
        ...
        scholarshipId: created.id,
        matchPercentage: isMatched
          ? s.hostCountry === 'Germany'
            ? 96
            : s.hostCountry === 'United Kingdom'
              ? 92
              : 88
          : 74,
